...
public class MultiMediaDropper11 extends Application {
        ...
        if (db.hasFiles()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                scriptBuilder.append("{\n")
                        .append("  backgroundImage: \"assets/images/").append(image.getName()).append("\",\n")
                        .append("  posterUrl: \"assets/images/").append(image.getName()).append("\",\n")
                        .append("  title: \"").append(title).append("\",\n")
                        .append("  album: \"Album Name\",\n")
                        .append("  year: 2025,\n")
                        .append("  artist: \"").append(artist).append("\",\n")
                        .append("  musicPath: \"assets/music/").append(audio.getName()).append("\"\n")
                        .append("},\n\n");
            }
